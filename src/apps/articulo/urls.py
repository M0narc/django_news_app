...
from .views import ArticuloDetalleView, ComentarioView, ArticuloUpdateView, ArticuloDeleteView,ArticuloSearchAndFilterView
from apps.comentario.views import agregar_comentario

urlpatterns = [
    path('', ArticuloSearchAndFilterView.as_view(), name='home'),
